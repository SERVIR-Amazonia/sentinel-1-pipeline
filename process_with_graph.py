...
import sys
sys.path.append('/usr/local/snap/snappy')
import os
import psycopg2
import subprocess
...
image_path = '/home/johnjdilger/sentinel1/images/'
slave_path = '/home/johnjdilger/sentinel1/slaves/'


intermediate_output_path = '/home/johnjdilger/sentinel1/intermediate_output/'
output_path = '/home/johnjdilger/sentinel1/output/'

graph_path = '/home/johnjdilger/pipeline.xml'
coregister_path = '/home/johnjdilger/coregister.xml'
coregister_template = '/home/johnjdilger/coregister_template.xml'

subset_path = '/home/johnjdilger/subset.xml'
subset_template = '/home/johnjdilger/subset_template.xml'
...
def get_slaves():
    ...
    for _data in data:
        pair = {
            'geom' : wkb.loads(_data[1], hex=True),#_data[1],
            'title': _data[0]
        }
        output.append(pair)
    return output
...
def main():
    ...
    for _data in data:
        try:
            ...
            if os.path.exists(intermediate_output_path+file_name+'_Orb_Cal_ML_TF.dim'):
